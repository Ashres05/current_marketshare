...
USING (
    ...
    linear_forecast AS (
        SELECT
            ...
            w.label_name,
            w.release_age,
            COALESCE(a.streaming_total, 0) AS streaming_total,
            COALESCE(a.product_sales, 0) AS product_sales,
            COALESCE(a.song_sale_equivalent, 0) AS song_sale_equivalent,
            COALESCE(a.streaming_equivalent, 0) AS streaming_equivalent,
            TRUE AS forecast
        FROM
            dates da
